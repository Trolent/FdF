...
/*   Updated: 2024/02/21 15:52:39 by trolland         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*z_range_str(double z_range)
{
	...
	str = ft_strjoin("Z range : ", ft_itoa(z_range * 100));
	return (str);
}
...
void	make_menu(t_vars *vars, t_data *img)
{
	...
	print_text(vars, img, "Show diagonals : D", &line_sep);
	print_text(vars, img, "Change color : C", &line_sep);
	print_text(vars, img, "--------------------", &line_sep);
	print_text(vars, img, "View from top : T", &line_sep);
	print_text(vars, img, "View ISO : I", &line_sep);
	print_text(vars, img, "View lateral : Y", &line_sep);
	print_text(vars, img, "Recenter position : R", &line_sep);
